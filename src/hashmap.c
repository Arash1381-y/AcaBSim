...
void
hashmap_set_grow_by_power (struct hashmap *map, size_t power)
{
  map->growpower = power < 1 ? 1 : power > 16 ? 16 : power;
}

static double
clamp_load_factor (double factor, double default_factor)
{
...
void
hashmap_set_load_factor (struct hashmap *map, double factor)
{
...
bucket_at0 (void *buckets, size_t bucketsz, size_t i)
{
...
static bool
resize0 (struct hashmap *map, size_t new_cap)
{
...
const void *
hashmap_delete (struct hashmap *map, const void *key)
{
...
//-----------------------------------------------------------------------------
static uint64_t
MM86128 (const void *key, const int len, uint32_t seed)
{
...
static uint64_t
xxh3 (const void *data, size_t len, uint64_t seed)
{
